  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      ol { margin: 0; padding-left: 20px; color: #d7dde7; line-height: 1.65; }
      ...
      <section>
        <div class="shell">
          ...
          <div class="panel">
            <h2>Next Steps</h2>
            <ol>
              <li>Replace the demo handler with the full OpenClaw runtime image once OCIR accepts the large upstream image reliably.</li>
              <li>Wire the run endpoint to your preferred tool sandbox and persist traces to the portal audit log.</li>
              <li>Attach a policy pack for allowed tools, network boundaries, and approval-required actions.</li>
            </ol>
          </div>
        </div>
      </section>
