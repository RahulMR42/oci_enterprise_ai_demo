...
test("portal opens administration as a separate page", () => {
  ...
  assert.match(indexHtml, /href="\/src\/styles\.css\?v=0\.0\.24"/);
  assert.match(indexHtml, /src="\/src\/main\.js\?v=0\.0\.24"/);
  assert.match(adminHtml, /id="administration"/);
  assert.match(adminHtml, /href="\/src\/styles\.css\?v=0\.0\.24"/);
  assert.match(adminHtml, /src="\/src\/admin\.js\?v=0\.0\.24"/);
