# Conversation Store Infrastructure
...
The runtime uses the shared OCI Generative AI project/API key from `infra/responses-api`. Startup exports `OCI_GENAI_CONVERSATION_ID` from generated metadata when present; otherwise the backend can create a conversation lazily.
