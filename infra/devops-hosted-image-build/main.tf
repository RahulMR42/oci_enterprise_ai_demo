...
resource "oci_devops_build_run" "this" {
  ...
  build_run_arguments {
    ...
    items {
      ...
      value = var.portal_vector_store_id != null ? var.portal_vector_store_id : ""
    }
    items {
      name  = "PORTAL_CODE_INTERPRETER_CONTAINER_ID"
      value = var.portal_code_interpreter_container_id != null ? var.portal_code_interpreter_container_id : ""
    }
    items {
      name  = "SHARED_POLICY_ID"
