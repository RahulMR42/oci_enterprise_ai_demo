...
**Tech Stack:** Node.js test runner, vanilla portal UI, Python 3, `llama-index-core`, OCI OpenAI-compatible Responses API helper in `backend/demos/common_oci.py`, Terraform-generated metadata from `infra/hosted-agentic-applications/.terraform/generated/hosted_app_idcs_client.json`.
