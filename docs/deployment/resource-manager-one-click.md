...
- builds the hosted demo container images,
- uploads each image through parallel OCI DevOps `DELIVER_ARTIFACT` stages,
- runs one managed build stage to create or update hosted deployments.
...
| `devops_source_branch` | the release branch you want Resource Manager to clone |
